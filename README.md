...
`usagent` polls provider usage for Claude Code/Fable, OpenAI, and z.ai, normalizes it to a stable JSON model, and exposes it over HTTP for Noctalia or any other client.
